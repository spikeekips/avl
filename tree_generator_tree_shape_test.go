...
func (t *testTreeGeneratorShape) parseNodeKey(b []byte) int {
	i, _ := strconv.ParseInt(string(b), 10, 64)
	return int(i)
}

func (t *testTreeGeneratorShape) print(tg *TreeGenerator, verbose bool) { // nolint
...
func (t *testTreeGeneratorShape) newNode(i int) *ExampleMutableNode {
	return &ExampleMutableNode{
